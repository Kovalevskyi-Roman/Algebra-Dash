...
class TilePropertyScreen:
    def __init__(self) -> None:
        ...
        self.__color_lbl: pygame.Surface = UIConfig.fonts.get("jetbrains_20m").render("Color", True, "#ffffff")
        ...
        self.__group_ids_lbl: pygame.Surface = UIConfig.fonts.get("jetbrains_20m").render("Group id's", True, "#ffffff")
        ...
        self.__tile_group_ids_lbl: pygame.Surface = UIConfig.fonts.get("jetbrains_20l").render("", True, "#ffffff")
    ...
    def on_enter(self, selected_tiles: list[Tile]) -> None:
        ...
        self.__tile_group_ids_lbl = UIConfig.fonts.get("jetbrains_20l").render(str(group_ids), True, "#ffffff")
